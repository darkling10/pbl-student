...
const prompts = [
  ...
  //2
  [
    "where is Attendance Info",
    "Where Attendance",
    "Where can I find my Attendance records",
  ...
  //5
  [
    "Where can I find Study material for My course",
    "Study material ",
    "Books",
    "pdf",
    "Mcq's",
  ...
  //6
  [
    "where is notice board",
    "where can I found latest news",
    "where NoticeBoard",
    "where is Notice Board",
  ],
  //7
...
const replies = [
  //1
  [
    "Hello!, Welcome to Sinhgad College SE ERP website ",
    "Hi there!,Chat-BOT here",
